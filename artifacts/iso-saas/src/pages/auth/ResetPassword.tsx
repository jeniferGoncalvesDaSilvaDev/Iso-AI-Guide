...
export default function ResetPassword() {
  ...
  const onSubmit = async (data: ResetForm) => {
    if (!token) {
      setErrorMsg("Token de recuperação inválido. Solicite um novo link.");
      return;
    }
    setErrorMsg("");
    setIsLoading(true);
      ...
      <div className="min-h-screen flex flex-col justify-center p-4 bg-background relative overflow-hidden">
        ...
        <div className="w-full max-w-md mx-auto space-y-8 relative z-10">
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-foreground">Link inválido</h1>
          </div>
    ...
    <div className="min-h-screen flex flex-col justify-center p-4 bg-background relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto space-y-8 relative z-10">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Redefinir sua senha</h1>
          <p className="text-muted-foreground">
